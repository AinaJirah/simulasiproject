            ...
            <div class="card-header">
                <div class="btn-group mb-2 mr-2">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="/kades/peminjaman">Menunggu Konfirmasi</a>
                        <a class="dropdown-item" href="/kades/menunggu-dikembalikan">Menunggu Dikembalikan</a>
                        <a class="dropdown-item" href="/kades/peminjaman-selesai">Peminjaman Selesai</a>
                    </div>
                </div>
            </div>
            <div class="card-body table-border-style">
                <form action="/kades/peminjaman-selesai-cari" method="post" id="formCariCetak">
                    <div class="row">
                        <div class="col-md-2">
...
<script>
    document.getElementById('btnCetak').addEventListener('click', function(event) {
        ...
        if (!tgl_awal || !tgl_akhir) {
            ...
            window.open(`/kades/print-peminjaman-selesai/${tgl_awal}/${tgl_akhir}`, '_blank');
        }
    });
</script>