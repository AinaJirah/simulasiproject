    ...
    <div class="navbar-wrapper  ">
        <div class="navbar-content scroll-div ">
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                    <a href="/peminjam" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Dashboard</span></a>
                </li>
                <li class="nav-item pcoded-menu-caption">
                    <label>Management</label>
                </li>
                <li class="nav-item">
                    <a href="/peminjam/aset-barang" class="nav-link "><span class="pcoded-micon"><i class="feather icon-package"></i></span><span class="pcoded-mtext">Aset Barang</span></a>
                </li>
                <li class="nav-item">
                    <a href="/peminjam/peminjaman" class="nav-link "><span class="pcoded-micon"><i class="feather icon-external-link"></i></span><span class="pcoded-mtext">Peminjaman</span></a>
                </li>
            </ul>
