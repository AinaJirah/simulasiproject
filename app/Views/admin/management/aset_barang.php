...
foreach ($aset as $data) : ?>
    <!-- MODAL DETAIL FOTO -->
    <div id="modalFoto<?= $data['id_aset']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <img src="<?= base_url('img/aset/' . $row['foto']); ?>" alt="Foto Aset" width="500">
                </div>
            </div>
        </div>
    </div>
